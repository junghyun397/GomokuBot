...
아무런 추가 규칙이 없는 단순한 오목은 1980년 Stefan Reisch에 의해 흑과 백 모두 최선의 수를 둔다고 해도 흑은 항상 필승 전략을 찾아낼 수 있음이 증명됐습니다. 
...
렌주는 흑 선공의 압도적 유리함을 해결하기 위해 **금수** 규칙을 선택했습니다. 금수는 특별한 조건을 만족하는 위치에 흑의 착수를 금지하는 규칙으로, 3-3 금지와 4-4 금지, 그리고 6목 금지까지 총 3가지의 금지 규칙이 있습니다.
...
좋은 소식이 있습니다(아쉽게도 흑에만요). 오목으로 승리할 수 있는 자리에 금수가 만들어진다고 해도, 오목으로 승리할 수 있다면 그 어떤 금수도 무시한 채 착수할 수 있습니다. 뒷목 잡을 일은 없겠군요!
...
아래와 같은 상황에 대해 생각해 봅시다. 흑은 과연 ``h9``에 둘 수 있을까요? 얼핏 보기에는 ``h9``는 h행에 세로로 배열된 돌 두 개와 9열에 가로로 배열된 돌 두 개에 의해 만들어지는 3-3금수로, 흑은 ``i9``에 둘 수 없어야만 할 것 같습니다.
...
렌주의 금수는 흑에 있어 장애물일 뿐이지만, 백에 있어서는 전략이자 기회입니다. 금수의 정의에 다시 집중해 보세요. 흑은 오목을 제외한 그 어떤 경우에도 금수에 착수할 수 없습니다. 백이 금수에 착수해 승리할 수 있더라도 예외가 될 수 없습니다.

![](https://raw.githubusercontent.com/junghyun397/GomokuBot/master/images/forbid-trap-simple.png)

여기 재미있는 상황이 하나 있습니다. 흑은 3-3 금수를 하나 가지고 있으며, 백은 흑의 3-3 금수를 사이에 두고 돌 3개를 늘어놓아 4공격을 위한 준비를 끝냈습니다. 여기서 백이 흑의 금수를 끼고 4를 만들어 공격한다면, 흑은 어떻게 대처할 수 있을까요? 
...
이 상황에서 주목해야 할 것은 백은 4를 만들어 흑이 ``g8``에 두어야만 하게 만들 수 있다는 점과, 흑이 ``g8``에 착수한다면 3-3금수가 생긴다는 점입니다.
...
이게 바로 렌주의 묘미입니다! 백은 3-3 금수뿐만 아니라 4-4 금수, 6목 금수 역시 같은 방법으로 유도해 내 이길 수 있습니다. 흑은 상황을 잘 읽어, 금수 유도에 빠져 게임을 망치지 않도록 특별히 주의해야만 합니다.

## 금수가 아닌 것으로 만들어 빠져나갈 수 있습니다.

여기 반전 하나가 있습니다. 흑은 금수 유도에 걸리지 않은 채 이길 수 있었습니다. ``f6``은 흑에게 정말로 좋은 자리입니다. 하지만 앞서 확인해 봤듯이, ``f6``에 둔다면 흑은 백의 금수 유도에 걸려 패배하게 될 것입니다. 흑은 어떻게 해야 안전하게 ``f6``에 착수할 수 있을까요?
